...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  const handleDeviceOrientation = useCallback(
    (event: DeviceOrientationEvent) => {
      ...
      const x = clamp(
        centerX + (gamma || 0) * mobileTiltSensitivity,
        0,
        shell.clientWidth
      );
      const y = clamp(
        centerY +
          ((beta || 0) - ANIMATION_CONFIG.DEVICE_BETA_OFFSET) *
        ...
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className="pc-content pc-header-content">
              <div className="pc-details centered">
                <h3>{name}</h3>
                <p>{title}</p>
              </div>
            </div>
            <div className="pc-content pc-avatar-content large">
              {avatarUrl && (
                <img
              ...
              {showUserInfo && (
                <div className="pc-user-info-overlay">
